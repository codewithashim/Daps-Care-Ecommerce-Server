...
const homeproductslider_model_1 = require("./homeproductslider.model");
// ==== add popular category =====
const addPopularCategory = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const popularCategory = new homeproductslider_model_1.PopularCategory(payload);
...
const getPopularCategories = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield homeproductslider_model_1.PopularCategory.find().populate("categories");
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, "Internal Server Error");
...
const deletePopularCategory = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield homeproductslider_model_1.PopularCategory.findByIdAndDelete({ _id: id });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, "Internal Server Error");
...
const getSinglePopularCategory = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield homeproductslider_model_1.PopularCategory.findById({ _id: id }).populate("categories");
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, "Internal Server Error");
...
const updatePopularCategory = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield homeproductslider_model_1.PopularCategory.findByIdAndUpdate({ _id: id }, payload, {
            new: true,
        });
        return result;
    }
